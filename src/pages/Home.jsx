...
export default function Home() {
  ...
  return (
    <div>
      {/* HERO */}
      <div className="relative w-full h-[450px] md:h-[500px] lg:h-[550px] mt-[113px]">
          ...
          {staticCategories.length === 0
            ...
            : staticCategories.map((cat) => (
                <Link key={cat.id} to={`/${cat.name}`}>
                  <div className="card shadow-sm hover:shadow-lg transition-shadow duration-300 overflow-hidden">
